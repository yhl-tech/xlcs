...
3、在提问完上述5个问题之后，说出测试结束引导语："到这里，本次测试就全部结束了。最后想问一下，您现在的心情怎么样？和刚开始测试时相比，有什么变化吗？"
    - 在用户回答心情后，给出结束语："好的，再次感谢您的时间。测试结果将由AI协同专业人员进行分析。测试报告将会在 6 到 8 小时生成，可登录查看，祝您生活愉快！再见！"
...
export const POST_TEST_QUESTIONS = [
  ...
  {
    key: 'like',
    text: '好的，那现在，在十张图片里，选择最喜欢的那一张，你最喜欢哪一张？'
  },
  {
    key: 'like_why',
    text: '请解释一下原因。'
  ...
  {
    key: 'dislike',
    text: '好的，那最后一个问题，在十张图片里，选择最不喜欢的那一张，你最不喜欢哪一张？'
  },
  {
    key: 'dislike_why',
    text: '请解释一下原因。'
